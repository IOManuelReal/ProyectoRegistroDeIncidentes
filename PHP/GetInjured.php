...
$json=array();
	...
	if(isset($_GET["idPatient"])){
		...
		injured.gender, injured.age, injured.injuries from registroincidentes.injured inner join 
		registroincidentes.user on injured.regUser = user.idUser where idPatient= '{$idPatient}'";
